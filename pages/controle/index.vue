...
<script>
    export default {
        created: function () {
            this.$store.commit('alterarTitulo', "Calendario")
        },
        data: () => ({
            today: Date(),
            focus: Date(),
            ...
            events: [
                ...
                },
                {
                    ...
                    start: "2019-11-07 09:00",
                    end: "2019-11-07 09:30",
                    color: "indigo"
                },
                {
                    name: "Large Event",
                ...
                },
                {
                    ...
                    start: "2019-11-07 08:00",
                    end: "2019-11-07 11:30",
                    color: "red"
                },
                {
                    name: "Another Meeting",
                    details: "Another important meeting about nothing",
                    start: "2019-11-07 10:00",
                    end: "2019-11-07 13:30",
                    color: "brown"
                },
                {
                    name: "7th to 8th",
                ...
                },
                {
                    ...
                    start: "2019-11-07 12:00",
                    end: "2019-11-07 15:00",
                    color: "deep-orange"
                },
                {
                    name: "30th Birthday",
                ...
                {
                    name: "event 3",
                    start: "2019-11-14 18:30",
                    end: "2019-11-14 20:30",
                    color: "#4285F4"
                },
                {
                    name: "event 4",
                ...
                },
                {
                    ...
                    end: "2019-11-14 23:00",
                    color: "#4285F4"
                },
                {
                    name: "event 7",
                    start: "2019-11-14 22:00",
                    end: "2019-11-14 23:00",
                    color: "#4285F4"
                }
            ],
